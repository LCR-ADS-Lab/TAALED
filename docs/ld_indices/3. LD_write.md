...
We can calculate the indices with/without parallel analysis (see the **LEARN More** section at the bottom of this page to learn more about parallel analysis).
