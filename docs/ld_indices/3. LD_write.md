...
**LD write function** allows you to save your analysis into a *txt* file. Along the way, it also batch processes multiple input text files, which is a useful feature in many use cases.
