...
Maas' index is a more complex transformation of TTR that attempts to fit the value to a logarithmic curve. It is often referred to simply as *Maas* (Maas, 1972<sup>[13](TAALED/references/1.%20Studies.html#maas-h-d-1972)</sup>).
...
| [Avoid](TAALED/ld_indices/2.%20Classic_LD_indices.html#calculate-classic-but-flawed-ld-indices)  (★☆☆)|MSTTR,  Log TTR,  Root TTR,  Simple TTR      
