...
💡 For more information about the LD indices calculated by TAALED, read **▶︎LEARN MORE**.

💡 For a guideline for index selection considering minimum text length, go directly to the [Summary](#summary).



**[Review] Create ldvals object**
```python
...
* MATTR has been demonstrated as one of the measures that meaningfully contributes to the human judgment of LD (Kyle et al., 2021)<sup>[11](https://lcr-ads-lab.github.io/TAALED/references/1.%20Studies.html#kyle-k-crossley-s-a--jarvis-s-2021)</sup>.


## MTLD<sup>★★★</sup>
The Measure of Textual Lexical Diversity (MTLD; McCarthy, 2005<sup>[15](https://lcr-ads-lab.github.io/TAALED/references/1.%20Studies.html#mccarthy-p-m-2005)</sup>; McCarthy & Jarvis, 2010<sup>[17](https://lcr-ads-lab.github.io/TAALED/references/1.%20Studies.html#mccarthy-p-m--jarvis-s-2010)</sup>) essentially measures the average number of tokens it takes to reach a specified TTR value (i.e., .720). There are variants of MTLD implementation.
...
* Koizumi and In’nami (2012)<sup>[10](https://lcr-ads-lab.github.io/TAALED/references/1.%20Studies.html#koizumi-r--innami-y-2012)</sup> used similar methods and obtained the same pattern of results. Among simple TTR, Root TTR, Maas, vocd-D, HD-D, and MTLD, MTLD was the only index that produced stable values, with stabilization occurring at around 100 tokens.

* Following the parallel sampling approach in Koizumi et al. (Koizumi, 2012<sup>[9](https://lcr-ads-lab.github.io/TAALED/references/1.%20Studies.html#koizumi-r-2012)</sup>; Koizumi & In'nami, 2012<sup>[10](https://lcr-ads-lab.github.io/TAALED/references/1.%20Studies.html#koizumi-r--innami-y-2012)</sup>), Zenker and Kyle (2021)<sup>[20](https://lcr-ads-lab.github.io/TAALED/references/1.%20Studies.html#zenker-f--kyle-k-2021)</sup> evaluated MTLD using 4,542 argumentative essays by English learners from Asian regions. The result indicated that MTLD-Original and MTLD-MA-Wrap were robust to even shorter texts such as 50 words.

* McCarthy and Jarvis (2010)<sup>[17](https://lcr-ads-lab.github.io/TAALED/references/1.%20Studies.html#mccarthy-p-m--jarvis-s-2010)</sup> observed a very low correlation between MTLD-Original and the text length (using a corpus comprising texts from a range of registers such as editorials, official documents, academic prose, fiction, etc.). They also found that MTLD had a low correlation with the simple TTR, which can be a desirable property of a lexical diversity index since the simple TTR strongly correlates with text length.
...
* The hypergeometric distribution diversity index (HDD) is a more reliable calculation of *vocd-D* (Malvern & Richards, 1997<sup>[12](https://lcr-ads-lab.github.io/TAALED/references/1.%20Studies.html#malvern-d--richards-b-2002)</sup>). It relies on the probability that a word in a text would be included in a random sample from the text (McCarthy & Jarvis, 2007<sup>[16](https://lcr-ads-lab.github.io/TAALED/references/1.%20Studies.html#mccarthy-p-m--jarvis-s-2007)</sup>). For each word type in a text, HD-D uses the hypergeometric distribution to calculate the probability of encountering one of its tokens in a random sample of 42 tokens. These probabilities are then added together to produce the final HD-D value for the text. We convert this to the same scale as TTR for ease of interpretation.

* Observing that vocd-D was rapidly becoming the preferred LD measures in the field, McCarthy and Jarvis (2007)<sup>[16](https://lcr-ads-lab.github.io/TAALED/references/1.%20Studies.html#mccarthy-p-m--jarvis-s-2007)</sup> conducted an assessment of its sensitivity to text length using a corpus of 23 genres taken from various corpora. As a result, they concluded that vocd-D scores were not as independent of text length. In contrast, they found a small relationship (r=.282) between text length and HD-D for longer texts (up to 2000 words).

* Koizumi and In'nami (2012)<sup>[10](https://lcr-ads-lab.github.io/TAALED/references/1.%20Studies.html#koizumi-r--innami-y-2012)</sup>, using a relatively small sample (n=38) of spoken L2 texts, found that HD-D was less affected by text length than other commonly used indices, while still reporting meaningful and significant effects.

* Zenker and Kyle (2021)<sup>[20](https://lcr-ads-lab.github.io/TAALED/references/1.%20Studies.html#zenker-f--kyle-k-2021)</sup>, using a large corpus (n = 4,542) of written L2 argumentative texts found a negligible relationship (r = 0.064) between HD-D and text length.
...
* McCarthy and Jarvis (2010)<sup>[17](https://lcr-ads-lab.github.io/TAALED/references/1.%20Studies.html#mccarthy-p-m--jarvis-s-2010)</sup> showed that Maas index was one of the main predictors of their register prediction model (along with MTLD and vocd-D).
