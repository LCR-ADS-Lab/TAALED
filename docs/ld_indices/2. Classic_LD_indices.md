...
TTR is calculated as the number of unique words in a text (types) divided by the number of running words (tokens) (Johnson, 1944<sup>[8](TAALED/references/1.%20Studies.html#johnson-w-1944)</sup>).
...
Root TTR is calculated as the number of types divided by the square root of the number of tokens (Guiraud, 1960<sup>[4](TAALED/references/1.%20Studies.html#guiraud-p-1960)</sup>, also called *Guirad's index*).
...
Log TTR is calculated by dividing the logarithm of the number of word types by the logarithm of the number of word tokens (Chotlos, 1944<sup>[2](TAALED/references/1.%20Studies.html#chotlos-j-w-1944)</sup>; Herdan, 1960<sup>[5](TAALED/references/1.%20Studies.html#herdan-g-1960)</sup>, also known as *Herdan's C*).
```python
print(ldvals.lttr)
```
```result
...
## MSTTR<sup>★☆☆</sup>
The Mean-Segmental Type-Token Ratio (MSTTR) is the average TTR for successive segments of text containing a standard number of word tokens (Johnson, 1944<sup>[8](TAALED/references/1.%20Studies.html#johnson-w-1944)</sup>).
```python
print(ldvals.msttr)
```
```result
